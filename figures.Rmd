...
```{r titer information}
library(readxl)
sample_info.m <- read_excel("chohek/Final concentrations per sample update_V4.xlsx", 
...
if(grepl('chihchung', Sys.info()["nodename"])){
  base.path <- '~/GoogleDrive/Sequence/2018_Johan_HEK_CHO'
  # path.cho <- '../Sequence/2018_Johan_HEK_CHO/2018_11_JohanHekCho/CHO/'
  # path.hek <- '../Sequence/2018_Johan_HEK_CHO/2018_11_JohanHekCho/HEK293/'
}else if(grepl('jabba', Sys.info()["nodename"])){
  base.path <- '~/data2/Sequence/2018_Johan_HEK_CHO'
  # path.cho <- '~/data/Sequence/2018_Johan_HEK_CHO/2018_11_JohanHekCho/CHO/'
  # path.hek <- '~/data/Sequence/2018_Johan_HEK_CHO/2018_11_JohanHekCho/HEK293/'
}
...
## add PSIM data
PSIM.augmented <- fread('../databases/uniprot_PSIM/uniprot.human.PTM.csv') %>% 
  .[PTM.count>0] %>%
...
```{r fig4a}
tmd.dt <- fread('../databases/180509_proteomaps/Homo sapiens (Human).tsv', col.names = c('protein', 'l1', 'l2', 'l3', 'l4', 'gene', 'pos', 'color' ), header = F)
...
tmd.dt.color <- fread('../databases/180509_proteomaps/Homo sapiens (Human)rgb.tsv', na.strings = '', col.names = c('protein', 'l1', 'l2', 'l3', 'l4', 'gene', 'pos', 'color'))
